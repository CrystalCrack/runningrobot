...
landmine_color_range = {
    ...
    'blue_baf_head': [(105, 106, 165), (112, 255, 255)],
    'blue_baf_chest': [(107, 95, 118), (123, 255, 255)],
    'black_dir': [(0, 0, 0), (179, 51, 80)],

}

dangban_color = [(101, 99, 60), (114, 255, 255)]
# [(102, 115, 91), (116, 244, 255)]
...
def kickball():
    ...
    while True:
        ...
        if step == Step.KICK:
            # 以下是需要调整的参数
            #######################################################################
            distance_threshold = 125  # 踢球时球心的位置
            #######################################################################
...
def get_remote_edge_end():
    ...
    lines = list(filter(lambda x:norm(x)>10000,lines))
